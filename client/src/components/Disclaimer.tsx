    ...
    const disclaimerText = `
      <div class='disclaimer' >
        ...
        <ul style="margin-bottom: 0; padding-left: 20px;">
          <li>The performance and availability of this application may vary, especially as it is hosted on a free tier service (Render). You might experience delays, particularly after periods of inactivity.</li>
